        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewdBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ApprovedROI = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    LoanTypeId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LoanApplications_LoanTypes_LoanTypeId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoanApplications_LoanTypeId1",
                table: "LoanApplications",
                column: "LoanTypeId1");
        }
